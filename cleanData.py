...
# Excel sheet containing data must not have additional text beyond headers


xl = pd.ExcelFile("sample_data/Panama_raw.xlsx")
...
writer = pd.ExcelWriter('sample_data/Panama30.xlsx')
